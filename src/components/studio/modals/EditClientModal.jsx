...
export const EditClientModal = ({ isOpen, onClose, client }) => {
    ...
    const [avatar, setAvatar] = useState(null); // Base64 string or URL for storage
    ...
    return (
        <Modal
            ...
            subtitle="Modifiez les informations et les accès de cette entreprise."
            maxWidth="max-w-2xl"
        >
